...
# ══════════════════════════════════════════════════════════════════════════
st.set_page_config(page_title="Stock Hunter Pro v9.1", layout="wide")

if "refresh_key" not in st.session_state:
    st.session_state.refresh_key = 0

st.sidebar.markdown("## 🦅 Stock Hunter Pro v9.1")
...
menu = st.sidebar.radio(
    ...
    [
        ...
        "📰 3. ข่าวสารสดเรียลไทม์จากตลาดโลก"
    ]
)
...
elif menu == "📰 3. ข่าวสารสดเรียลไทม์จากตลาดโลก":
    st.title("📰 ตรวจสอบกระแสข่าวสารรอบด้านจากตลาดทุนทั่วโลก")
    st.caption("⚠️ ข้อมูลข่าวสารดึงตรงจากตลาดโลกแบบเรียลไทม์ โปรดอ่านเนื้อหาเต็มเพื่อประกอบการวิเคราะห์ข้อมูล")
